...
public class CommandTPS extends BaseCommand {
    ...
    public void onTPS(CommandSender sender) {
        ...
        builder.append("<gray><hover:show_text:'Ticks per second<gray>.</gray> <green>20</green> is optimal<gray>.</gray>'>TPS</hover><white>:</white> ");
        ...
        builder.append(" <italic>(15m)</italic>");
        ...
        tabTPS.getChat().send(sender, "<gray><hover:show_text:'Milliseconds per tick<gray>.</gray> MSPT <gray><</gray> 50 <gray>-></gray> <green>20 TPS</green>'>MSPT</hover><white>:</white> " + TPSUtil.getColoredMspt(tabTPS.getTpsUtil().getMspt()));
    }
}
