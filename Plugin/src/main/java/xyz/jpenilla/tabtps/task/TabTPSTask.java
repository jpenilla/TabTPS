...
public class TabTPSTask extends BukkitRunnable {
    ...
    public TabTPSTask(TabTPS tabTPS, Player player) {
        this.headerRenderer = new ModuleRenderer(player).modules(tabTPS.getPluginSettings().getModules().getTabHeader()).separator(" ").moduleRenderFunction(TabTPSTask::renderModule);
        this.footerRenderer = new ModuleRenderer(player).modules(tabTPS.getPluginSettings().getModules().getTabFooter()).separator(" ").moduleRenderFunction(TabTPSTask::renderModule);
        this.player = player;
        this.tabTPS = tabTPS;
    }
