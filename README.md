...
- [Paper](https://papermc.io)/Spigot API (Minecraft versions 1.8.8-1.18.2+)
- [Sponge](https://spongepowered.org) 8+
- Fabric (Minecraft 1.18.2, requires [Fabric API](https://www.curseforge.com/minecraft/mc-mods/fabric-api))
